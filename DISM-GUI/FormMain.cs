...
namespace DISM_GUI
{
    public partial class FormMain : Form
    {
        ...
        // Entrées:
        //
        // TxtBoxApplySource.Text:      Chemin et Nom complet du fichier WIM à appliquer
        // TxtBoxApplyDestination.Text: Chemin vers un dossier où l'image sera appliquée
        // CmbBoxApplyIndex.Text:       Numéro d'index dans le fichier WIM qui doit être appliqué
        //
        // Sorties:
        //
        // Révision le 15/11/2020
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (ChaineDossierDest.Length != 3) ChaineDossierDest = "\"" + ChaineDossierDest + "\"";
